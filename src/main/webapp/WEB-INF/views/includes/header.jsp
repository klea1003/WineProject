					  ...
					  <form class="user" id="login_form" method="post">
                    	<div class="mb-3">
	                    	...
	                    	<div class="modal-footer d-block">
	                       		<p class="float-start">Not yet account <a class="small" id="modal_show_logintojion">Sign Up</a></p>
	                        	<input type="button" id="login_button"	class="btn btn-warning float-end" value="Login">
	                    	</div>
				...
				<div class="modal-header">
					...
					<!-- 회원가입 영역  -->
								<div class="text-center">
									<h3 class="modal-title" id="exampleModalLabel">Welcome!</h3>
								</div>
								<form class="user" id="join_form" method="post">
									...
									<div class="mb-3">
										<input type="text" class="form-control form-control-user"
											...
											class="nickname_input_re_1">사용 가능한 닉네임입니다.</span> 
											<span class="nickname_input_re_2">닉네임이 이미 존재합니다.</span> <span
									...
									<div class="mb-3">
											...
											<div class="btn" id="email_check_button">
												<span>인증번호 전송</span>
											</div>
										</div>
