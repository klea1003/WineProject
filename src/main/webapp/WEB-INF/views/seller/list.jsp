...
<body>
	...
	<div class="container px-4 px-lg-5">
		...
		<!-- Heading Row-->
		<div class="gx-4 gx-lg-5 align-items-center my-5">
						...
						<div class="option">
							<div>
								<form onsubmit="searchPlaces(); return false;">
									키워드 : <input type="text" value="와인" id="keyword" size="15"> 
					...
					<div class="col-md-4 mb-5">
						<div class="card h-100">
							...
							<div class="card-footer">
								<a class="btn btn-outline-danger btn-sm" href="/seller/get?sellerNum=${seller.sellerNum}">More Info</a>
							</div>
						</div>
					</div>
				</c:forEach>	
