		...
		<div class="accordion accordion-flush mb-5" id="accordionFlushExample">
		  <div class="accordion-item">
		    ...
		    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
		      <div class="accordion-body">햇빛이 들지 않는 베란다 찬장 같은 곳에 <code>상온보관</code> 하시면 좋을 듯 합니다. 레드 와인이라면 위 방법으로 보관하시고 디저트 와인이나 화이트 와인 또는 샴페인이라면 <code>냉장보관</code> 해주세요!</div>
		    </div>
		  </div>
		  <div class="accordion-item">
		    <h2 class="accordion-header" id="flush-headingTwo">
		      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
		        개봉 후 와인은 하루나 이틀안에 다 먹어야 하나요?
		      </button>
		    </h2>
		    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
		      <div class="accordion-body">개봉된 와인의 보관 기간은 와인의 종류에 따라 다르지만 보통 3~5일 정도입니다.
체력이 강한 종류는 7일 정도까지 버티기도 하고,
일부 화이트 와인(아이스 와인이나 귀부와인 계통)의 것은 잘 버티면 2주 정도까지도 갑니다.
일반적으로는 레드가 화이트보다 체력이 강한 편입니다. <code>가급적 빨리 드시기를 권장합니다.</code><p>
추가로 개봉된 와인의 보관법은 크게 나누면 3가지입니다. <p>
1. 코르크로 다시 막거나 시중에서 파는 별도의 와인 병 마개 등으로 막아서 냉장보관<p>
2. 진공마개와 손펌프를 사용하여 내부 공기를 뽑아낸 뒤 냉장보관<p>
3. 이산화탄소나 질소 가스등 무색 무취의 비활성 가스를 병내에 주입한 뒤 1의 방법으로 보관합니다. 감사합니다.</div>
		    </div> 
		  </div>
		  <div class="accordion-item">
		    <h2 class="accordion-header" id="flush-headingThree">
		      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
		        와인 숙성 온도가 어떻게 되나요? + 와인 숙성 어떻게 하나요?
		      </button>
		    </h2>
		    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
		      <div class="accordion-body"> 순수하게 보관만 생각했을 때 적정 보관 온도에 대해서는 딱히 정해진 법칙은 없습니다. 기본적인 원칙은 <code>'온도가 올라갈수록 숙성은 가속되고, 온도가 내려갈수록 숙성은 느려진다.'</code> 입니다.
              즉, 장기 숙성 기간을 얼마나 잡느냐에 따라 온도 보관 방법도 달라질 수 있습니다. 장기 보관을 대부분 20~30년 정도로 생각하시고 서서히 숙성을 계속하여 20년 정도 시점에서 맛의 정점을 찍을 정도의 보관 온도는 섭씨 12~14도 정도가 보관 온도로서 적당합니다.</div>
		    </div>
		  </div>
		</div>
